...
/**
 * Esta clase representa una línea circular en el sistema de transporte.
 ...
 * recorrido circular.
 */
public class LineCircular_21451730_VejarBranada implements LineInterface_21451730_VejarBranada {
    /**
     * Variable: Id.
     */
    public int id;
    ...
    /**
     * Constructor Vacio: Instancia una lineaCircular sin atributos
     *
     */
    public LineCircular_21451730_VejarBranada() {
    }

    /**
     * Constructor: Instancia una Lineacircular.
     *
     * @param id:int
     * @param name:String
     * @param railType:String
     * @param section21451730VejarBranadas:Section
     */
    public LineCircular_21451730_VejarBranada(int id, String name, String railType, List<Section_21451730_VejarBranada> section21451730VejarBranadas) {
        this.id = id;
        this.name = name;
    ...
    public boolean isLine() {
        ...
        for(int g = 0; g<tamanoArreglo;g++){
            if(section21451730VejarBranadas.get(g).point1.type.equals("t")){
                return false;
            }
            if(section21451730VejarBranadas.get(g).point2.type.equals("t")){
                return false;
            }
