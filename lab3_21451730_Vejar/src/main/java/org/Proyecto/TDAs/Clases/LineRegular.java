...
public class LineRegular implements LineInterface {
    public int id;
    public String name;
    ...
    public LineRegular(int id, String name, String railType, List<Section> sections) {
        this.id = id;
        this.name = name;
    ...
    public boolean isLine() {
        ...
        if (!sections.get(0).point1.type.equals("t")) {
            return false;
        }
        if (!sections.get(tamanoArreglo - 1).point2.type.equals("t")) {
            return false;
        }
